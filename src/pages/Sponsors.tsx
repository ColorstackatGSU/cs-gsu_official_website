      ...
      <section className="py-20" style={{ background: 'var(--paper-warm)' }}>
        <div className="container-wide text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-8 fade-in-up fade-delay-2">
            <div className="border border-gsu-med-gray bg-white/5 p-6 flex flex-col items-center justify-center w-64 h-44">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#76B900" className="w-20 h-20 mb-3" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <div className="border border-gsu-med-gray bg-white/5 p-6 flex flex-col items-center justify-center w-64 h-44">
              <img
                ...
                loading="lazy"
              />
              <span className="font-bold tracking-wider text-sm uppercase text-white">Equifax</span>
            </div>
          </div>
        </div>
      </section>
