    ...
    <>
      <section className="interior-hero-pad text-white" style={{ background: 'var(--paper)' }}>
        <div className="container-wide max-w-3xl text-center fade-in-up">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a href="mailto:official@colorstackatgsu.com" className="btn-accent rounded-none">
            ...
            <a href={PACKET_URL} target="_blank" rel="noopener noreferrer" className="btn-accent rounded-none">
              Open packet
            </a>
            <a href={PACKET_URL} download className="btn-secondary rounded-none !border-white/40 !text-white hover:!border-gsu-light-blue hover:!text-gsu-light-blue">
              Download PDF
            </a>
          </div>
      ...
      <section className="py-20" style={{ background: '#ffffff' }}>
        <div className="container-wide text-center">
          <h2 className="text-2xl text-slate-900 font-bold fade-in-up fade-delay-1">Our current partners</h2>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-8 fade-in-up fade-delay-2">
            <div className="border border-slate-200 bg-slate-50 p-8 flex flex-col items-center justify-center w-64 h-36">
